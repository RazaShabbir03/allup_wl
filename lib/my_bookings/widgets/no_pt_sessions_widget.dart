...
class EmptyPTSessionsWidget extends StatelessWidget {
  const EmptyPTSessionsWidget({super.key});
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        SizedBox(height: 20.h),
        Text(
            'This will be the place where you can find a list of all your sessions.',
